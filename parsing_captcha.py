...
Алгоритм разбора не умеет разбирать буквы, которые по вертикали
не имеет просветов. Решением может улучшение алгоритма поиска просветов
в функции border_letters или добавлением масок "слипшихся" букв.
"""
